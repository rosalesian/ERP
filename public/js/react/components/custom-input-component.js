...
window.Item = React.createClass({
	...
	render : function () {
		return (
			<td>
				<Select className="react-select-input-lineitem" name="form-field-name" value={this.state.defaultValue} options={this.getItems()} onChange={this.handleChange} clearable={false} />
			</td>
		);
	}
});
