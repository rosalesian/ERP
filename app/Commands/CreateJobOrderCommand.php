...
class CreateJobOrderCommand extends Command 
{
    public $transnumber;
    public $transdate;
    public $asset_id;
     ...
     * @return void
     */
    public function __construct($transdate, $asset_id, $requested_by, $maintenancetype_id, $prcategory_id, $purchaserequest_id, $memo, $labor_costs)
    {
