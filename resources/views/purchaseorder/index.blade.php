  ...
  <div class="col-md-12">
   ...
   <div class="transaction-buttons-container">
      <div class="trans-button">
        <a href="{{url('transactions/purchaserequest/create ')}}" class="btn btn-block btn-primary btn-flat">New Purchase Order</a>
      </div>
   </div>
            ...
            <tr role="row">
              ...
              <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 56px;" aria-label="Salary: activate to sort column ascending">
                ...
                <tr role="row" class="odd">
                  <td><a href="{{ url('transactions/purchaseorder/1/edit') }}">Edit</a> <small>|</small> <a href="{{ url('transactions/purchaseorder/1') }}">View</a></td>
