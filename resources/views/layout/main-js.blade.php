    ...
    <!-- React Plugins -->
    {{-- // <script src="{{ asset('js/react/plugin/classnames/bind.js') }}"></script> <!-- classnames --> --}}
    {{-- // <script src="{{ asset('js/react/plugin/classnames/dedupe.js') }}"></script> <!-- classnames --> --}}
    ...
    {{-- // <script src="{{ asset('js/react/plugin/react-select/dist/react-select.js') }}"></script> <!-- select --> --}}
